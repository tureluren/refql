...
interface Prop<TableId extends string = any, As extends string = any, Output = any, Params = any, IsOmitted extends boolean = any, HasDefault extends boolean = any, HasOp extends boolean = any> extends RQLNode, PropType<As> {
  ...
  eq<Params2 = {}>(run: TagFunctionVariable<Simplify<Params & Params2>, Output> | Output): Prop<TableId, As, Output, Simplify<Params & Params2>, IsOmitted, HasDefault, true>;
  notEq: this["eq"];
  isNull<Params2 = {}>(): Prop<TableId, As, Output, Simplify<Params & Params2>, IsOmitted, HasDefault, true>;
  notIsNull: this["isNull"];
  like<Params2 = {}>(run: TagFunctionVariable<Simplify<Params & Params2>, string> | string): Prop<TableId, As, Output, Simplify<Params & Params2>, IsOmitted, HasDefault, true>;
  notLike: this["like"];
  iLike: this["like"];
  notILike: this["like"];
  in<Params2 = {}>(run: TagFunctionVariable<Simplify<Params & Params2>, Output[]> | Output[]): Prop<TableId, As, Output, Simplify<Params & Params2>, IsOmitted, HasDefault, true>;
  notIn: this["in"];
  gt<Params2 = {}>(run: TagFunctionVariable<Simplify<Params & Params2>, Output> | Output): Prop<TableId, As, Output, Simplify<Params & Params2>, IsOmitted, HasDefault, true>;
  gte: this["gt"];
  lt: this["gt"];
  lte: this["gt"];
  asc(): Prop<TableId, As, Output, Params, IsOmitted, HasDefault, true>;
  desc: this["asc"];
  or<Params2 = {}>(prop: Prop<TableId> | SQLProp<any, any, Params2>): Prop<TableId, As, Output, Simplify<Params & Params2>, IsOmitted, HasDefault, true>;
  and: this["or"];
